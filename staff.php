<?php
    ...
    $selectqry="select st_id,st_name,st_email,st_password,st_mobile,st_qualification,st_experience,st_dob,st_gender,usertype_name from tm_staff st inner join tm_usertype u on u.usertype_id=st.usertype_id order by st.usertype_id asc";
    $rsstaff=mysqli_query($con,$selectqry);
    ...
    {
        $stid=$_GET["edit"];
        $query="select st_id,st_name,st_email,st_password,st_mobile,st_qualification,st_experience,st_dob,st_gender,usertype_id from tm_staff where st_id=$stid";
        $rsstaff=mysqli_query($con,$query);
        $erow=mysqli_fetch_row($rsstaff);
        $sname=$erow[1];
        $email=$erow[2];
        $contact=$erow[4];
        $dob=$erow[7];
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <li><a href="#"><i class="icon-user icon-2x" style="color:#00204a"></i><?php
                                    if(isset($_SESSION["uid"]))
                                    {
                                        $qry="select st_name from tm_staff where st_id=$stfid";
                        ...
                        <div class="panel" id="mainp">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-tabs">
                                    <li class='<?php if(!isset($stid)) echo "active"; else echo "";?>'><a href="#home" data-toggle="tab">View</a>
                                    </li>
                                    <li class='<?php if(isset($stid)) echo "active"; else echo "";?>'><a href="#profile" data-toggle="tab">Add Staff</a>
                                    </li>
                                </ul>
    
                                <div class="tab-content">
                                    <div class='<?php if(!isset($stid)) echo "tab-pane fade in active"; else echo "tab-pane fade";?>' id="home">
                                        <div class="col-lg-12">
                                            <!-- database Table -->
                                            <div class="panelo" id="tbpanelb">
                                                            ...
                                                            <?php
                                                                if(!$rsstaff)
                                                                        ...
                                                                        while($row=mysqli_fetch_row($rsstaff))
                                                                        {
                                                                            ...
                                                                            echo"<td>".$row[5]."</td>";
                                                                            echo"<td>".$row[9]."</td>";
                                                                            echo"<td><a class='btn btn-primary btn-sm' href='staff.php?edit=".$row[0]."'><i class='icon-pencil' style='color:white;'></i></a>
                                                                            </td>";
                                                                                ...
                                                                                <div class='modal-dialog'>
                                                                                    <div class='modal-content'>
                                                                                        ...
                                                                                        <div class='modal-footer'>
                                                                                            ...
                                                                                            <a type='button'  class='btn btn-primary ' href='dbstaff.php?del=$row[0]'>Delete</a>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                </div>
                                    ...
                                    <div class='<?php if(!isset($stid)) echo "tab-pane fade"; else echo "tab-pane fade in active";?>' id="profile">
                                        <form class="form-horizontal" id="popup-validation" method="post" action="dbstaff.php">
                                                        <!-- USERTYPE ID -->
                                        <div class="form-group">
                                                <label class="control-label col-lg-4">User-Type Id</label>
    
                                                <div class=" col-lg-4">
                                                    <select class="form-control" name="cmb_utid" id="cmb_utid">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" class="validate[required] form-control" name="txt_sname" id="txt_sname" value='<?php if(isset($stid)) echo $sname; ?>'>
                                                </div>
                                            </div>
                                                <!-- email -->
                                            <div class="form-group">
                                                ...
                                                <div class=" col-lg-4">
                                                    <input class="validate[required,custom[email]] form-control" type="text" name="txt_email"
                                                        id="txt_email" value='<?php if(isset($stid)) echo $email; ?>' />
                                                </div>
                                            </div>
                                                <!-- password -->
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="input-group">
                                                        <input class="validate[required] form-control" type="text" name="txt_contact" data-mask="+99-9999999999" value='<?php if(isset($stid)) echo $contact; ?>' />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class=" col-lg-4">
                                                    <input class="validate[required] form-control" type="date"
                                                        name="txt_dob" id="txt_dob" value='<?php if(isset($stid)) echo $dob; ?>' />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" class="validate[required] form-control" name="txt_qual" id="txt_qual" value='<?php if(isset($stid)) echo $qual;?>'>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" class="validate[required] form-control" name="txt_exp" id="txt_exp" value='<?php if(isset($stid)) echo $exp;?>'>
                                                </div>
                                            </div>

                                                <!-- button -->
                                                <div style="text-align:center" class="form-actions no-margin-bottom">
                                                <input type="submit" name="btn_submit" value='<?php if(!isset($stid)) echo "Add Staff"; else echo "Edit Staff"; ?>' class="btn btn-primary btn-lg " />
                                                <input type="hidden" name="esid" value='<?php if(isset($stid)) echo $stid; ?>' />
                                                </div>
                                        </form>
                                    </div>
                                </div>
