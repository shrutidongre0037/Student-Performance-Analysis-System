<?php
    ...
    $selectqry="select sem_id,sem_name from tm_semester";
    $rsuser=mysqli_query($con,$selectqry);

    if(isset($_GET["edit"]))
    {
        $sid=$_GET["edit"];
        $query="select sem_id,sem_name from tm_semester where sem_id=$sid";
        $rsesem=mysqli_query($con,$query);
        $erow=mysqli_fetch_row($rsesem);
        $sname=$erow[1];
    }
        ...
        <div id="content" style="margin-top:46px;">
            ...
            <div class="inner" style="min-height:1000px;margin-top:5px;">
                <div class="row"  style="margin-left:1px;">
                    <div class="col-lg-12">
                        <div class="panel panel-primary" id="mainp">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class='<?php if(isset($sid)) echo "active"; else echo "";?>'><a href="#profile" data-toggle="tab">Add Semesters</a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover" id="dtuser">
                                                            ...
                                                            <?php
                                                                    ...
                                                                    while($row=mysqli_fetch_row($rsuser))
                                                                    {
                                                                        ...
                                                                        echo"<td><a class='btn btn-primary btn-sm' href='semester.php?edit=".$row[0]."'><i class='icon-pencil' style='color:white;'></i></a>
                                                                        </td>";
                                                                            ...
                                                                            <div class='modal-dialog'>
                                                                                <div class='modal-content'>
                                                                                    ...
                                                                                    <div class='modal-footer'>
                                                                                        ...
                                                                                        <a type='button'  class='btn btn-primary ' href='dbsemester.php?del=$row[0]'>Delete</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            </div>
                                    ...
                                    <div class='<?php if(!isset($sid)) echo "tab-pane fade"; else echo "tab-pane fade in active";?>' id="profile">
                                        <form class="form-horizontal" id="popup-validation"  method="POST" action="dbsemester.php">
                                            <!-- Username -->
                                            <div class="form-group">
                                                <label class="control-label col-lg-4">Semester Name</label>
                                                <div class="col-lg-4">
                                                    <input type="text" class="validate[required] form-control" name="txt_sname" id="txt_sname" value='<?php if(isset($sid)) echo $sname;?>'>
                                                </div>
                                            </div>
                                                <!-- button -->
                                                <div style="text-align:center" class="form-actions no-margin-bottom">
                                                <input type="submit" name="btn_submit" value='<?php if(!isset($sid)) echo "Add Semester"; else echo "Edit Semester"; ?>' class="btn btn-primary btn-lg " />
                                                  <input type="hidden" name="scid" value='<?php if(isset($sid)) echo $sid; ?>' />
                                                </div>
                                        </form>
                                    </div>
                                </div>
